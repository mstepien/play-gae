...
bq. v1.9.71: GoogleAppEngine SDK 1.9.71 support*

* Works with Play version 1.5.1 and above
* Removed deprecated GAE APIs:
** XMPP API
** Backend

bq. v1.6.1.1: GoogleAppEngine SDK 1.6.1.1 support*
